...
export const approvedApps: ApprovedApp[] = [
  ...
  },
  {
    ...
    shortSummary:
      'A classroom communication and culture tool that helps teachers connect with students and families.',
    category: 'Learning Management & Communication',
  ...
  },
  {
    ...
    shortSummary:
      'A robust LMS experience for course materials, assignments, grades, and class organization.',
    category: 'Learning Management & Communication',
  ...
  },
  {
    ...
    shortSummary:
      'A school-centered LMS for managing instruction, assignments, discussions, and student progress.',
    category: 'Learning Management & Communication',
    gradeRanges: ['6-8', '9-12'],
  ...
  },
  {
    ...
    shortSummary:
      'A standards-aligned learning platform with lessons and practice across math, science, and more.',
    category: 'Math & STEM',
  ...
  },
  {
    ...
    shortSummary:
      'An adaptive practice platform with skill-based learning and immediate feedback across subjects.',
    category: 'Math & STEM',
    gradeRanges: ['Multi-level'],
  ...
  },
  {
    ...
    shortSummary:
      'A gamified math and reading platform built for younger learners and foundational skill growth.',
    category: 'Math & STEM',
    gradeRanges: ['Pre-K-2', '3-5'],
  ...
  },
  {
    ...
    shortSummary:
      'A concept-driven math tool with calculators and classroom activities for deeper understanding.',
    category: 'Math & STEM',
    gradeRanges: ['3-5', '6-8', '9-12'],
  ...
  },
  {
    ...
    shortSummary:
      'A digital reading library with books, audiobooks, and reading discovery for younger students.',
    category: 'Literacy & Language',
    gradeRanges: ['Pre-K-2', '3-5'],
  ...
  },
  {
    ...
    shortSummary:
      'An early learning platform focused on foundational reading, phonics, and beginner math skills.',
    category: 'Literacy & Language',
    gradeRanges: ['Pre-K-2'],
  ...
  },
  {
    ...
    shortSummary:
      'A self-paced or live quiz platform for review, comprehension checks, and quick classroom practice.',
    category: 'Study, Assessment & Engagement',
    gradeRanges: ['3-5', '6-8', '9-12'],
  ...
  },
  {
    ...
    shortSummary:
      'A collaborative digital board for brainstorming, discussion, media sharing, and project responses.',
    category: 'Study, Assessment & Engagement',
    gradeRanges: ['3-5', '6-8', '9-12'],
  ...
  },
  {
    ...
    shortSummary:
      'An interactive video lesson tool that lets teachers embed questions and track student progress.',
    category: 'Study, Assessment & Engagement',
    gradeRanges: ['3-5', '6-8', '9-12'],
  ...
  },
  {
    ...
    shortSummary:
      'An active learning tool that turns teacher slides into interactive lessons and formative checks.',
    category: 'Study, Assessment & Engagement',
    gradeRanges: ['3-5', '6-8', '9-12'],
  ...
  },
  {
    ...
    shortSummary:
      'A visual creation platform for presentations, posters, videos, and classroom storytelling.',
  ...
  },
  {
    ...
    shortSummary:
      'An introductory coding app that teaches sequencing and logic through simple visual storytelling.',
    category: 'Creativity, Coding & Projects',
    gradeRanges: ['Pre-K-2'],
  ...
  },
  {
    ...
    shortSummary:
      'A game-based coding experience for younger learners that builds logic and computational thinking.',
    category: 'Creativity, Coding & Projects',
    gradeRanges: ['Pre-K-2', '3-5'],
